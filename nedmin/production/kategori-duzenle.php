        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <form action="../netting/islem.php" method="POST" enctype="multipart/form-data" data-parsley-validate="" class="form-horizontal form-label-left">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <img width="200"  src="../../<?php echo $kategoricek['kategori_foto']; ?>">
                </div>
              </div>
              ...
              <input type="hidden" name="eski_yol" value="<?php echo $kategoricek['kategori_foto']; ?>">
            ...
            <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
             ...
             <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Kategori Onecikar<span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                 <select id="heard" class="form-control" name="kategori_onecikar" required>
                  <option value="1" <?php if ($kategoricek['kategori_onecikar']==1) { echo 'selected=""'; } ?>>Aktif</option>
                  <option value="0" <?php if ($kategoricek['kategori_onecikar']==0) { echo 'selected=""'; } ?>>Pasif</option>
                 </select>
               </div>
             </div>
