...
$kombinsor=$db->prepare("SELECT * FROM kombin where kombin_id=:id");
...
<div class="right_col" role="main">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
          <div class="x_title">
            <h2>kombin Düzenleme <small>,
              ...
              elseif ($_GET['durum']=="bos") {?>
                ...
                <b style="color:red;">Lütfen Bir Fotoğraf Seçiniz...</b>

              <?php }
              elseif ($_GET['durum']=="dosyabuyuk") {?>

                <b style="color:red;">Seçtiğiniz Dosyanın Boyutu Çok Büyük...</b>

              <?php }
              elseif ($_GET['durum']=="yanlisuzanti") {?>

                <b style="color:red;">Seçtiğiniz Dosyanın Uzantısı JPG veya PNG olmalıdır...</b>
          ...
          <div class="x_content">
            ...
            <form action="../netting/islem.php" method="POST" enctype="multipart/form-data" data-parsley-validate="" class="form-horizontal form-label-left">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <img width="200"  src="../../<?php echo $kombincek['kombin_foto']; ?>">
                </div>
              </div>
              ...
              <input type="hidden" name="eski_yol" value="<?php echo $kombincek['kombin_foto']; ?>">
              <input type="hidden" name="kombin_id" value="<?php echo $kombincek['kombin_id']; ?>">

              <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                <button type="submit" name="kombinfotoduzenle" class="btn btn-primary">Güncelle</button>
              </div>
                  ...
                  <select class="select2_group form-control" name="urun_idbir">
                    ...
                    while($kategoricek1=$kategorisor1->fetch(PDO::FETCH_ASSOC)) 
                    {
                      ...
                      <optgroup label="<?php echo $kategoricek1['kategori_ad'] ?>">
                        <?php
                        $kombin_idbir=$kombincek['urun_idbir'];
                        ...
                        {
                          $urun_id=$uruncek1['urun_id'];
                          ?>
                          <option <?php if ($kombin_idbir==$urun_id) { echo "selected='select'"; } ?>  value="<?php echo $uruncek1['urun_id']; ?>">Kod: <?php echo $uruncek1['urun_id']; ?> | <?php echo $uruncek1['urun_ad']; ?> </option>
                          <?php 
                        } 
                        ?>
                      </optgroup>
                ...
                <div class="col-md-6 col-sm-6 col-xs-6">
                  <select class="select2_group form-control" name="urun_idiki">
                    ...
                    while($kategoricek1=$kategorisor1->fetch(PDO::FETCH_ASSOC)) 
                    {
                      ...
                      <optgroup label="<?php echo $kategoricek1['kategori_ad'] ?>">
                        <?php
                        $kombin_idiki=$kombincek['urun_idiki'];
                        $kategori_id=$kategoricek1['kategori_id'];
                        $urunsor1=$db->prepare("SELECT * FROM urun where kategori_id=:kategori and urun_durum=:durum order by urun_id DESC");
                        $urunsor1->execute(array('kategori' => $kategori_id , 'durum'=>1));
                        ?>
                        ...
                        while($uruncek1=$urunsor1->fetch(PDO::FETCH_ASSOC)) 
                        {
                          $urun_id=$uruncek1['urun_id'];
                          ?>
                          <option <?php if ($kombin_idiki==$urun_id) { echo "selected='select'"; } ?>  value="<?php echo $uruncek1['urun_id']; ?>">Kod: <?php echo $uruncek1['urun_id']; ?> | <?php echo $uruncek1['urun_ad']; ?> </option>
                          <?php 
                        } 
                        ?>
                      </optgroup>
                ...
                <div class="col-md-6 col-sm-6 col-xs-6">
                  <select class="select2_group form-control" name="urun_iduc">
                    ...
                    while($kategoricek1=$kategorisor1->fetch(PDO::FETCH_ASSOC)) 
                    {
                      ...
                      <optgroup label="<?php echo $kategoricek1['kategori_ad'] ?>">
                        <?php
                        $kombin_iduc=$kombincek['urun_iduc'];
                        $kategori_id=$kategoricek1['kategori_id'];
                        $urunsor1=$db->prepare("SELECT * FROM urun where kategori_id=:kategori and urun_durum=:durum order by urun_id DESC");
                        $urunsor1->execute(array('kategori' => $kategori_id , 'durum'=>1));
                        ?>
                        ...
                        while($uruncek1=$urunsor1->fetch(PDO::FETCH_ASSOC)) 
                        {
                         $urun_id=$uruncek1['urun_id'];
                         ?>
                         <option <?php if ($kombin_iduc==$urun_id) { echo "selected='select'"; } ?>  value="<?php echo $uruncek1['urun_id']; ?>">Kod: <?php echo $uruncek1['urun_id']; ?> | <?php echo $uruncek1['urun_ad']; ?> </option>
                         <?php 
                       } 
                       ?>
                     </optgroup>
              ...
              <div class="col-md-6 col-sm-6 col-xs-6">
                <select class="select2_group form-control" name="urun_iddort">
                  ...
                  while($kategoricek1=$kategorisor1->fetch(PDO::FETCH_ASSOC)) 
                  {
                    ...
                    <optgroup label="<?php echo $kategoricek1['kategori_ad'] ?>">
                      <?php
                      $kombin_iddort=$kombincek['urun_iddort'];
                      $kategori_id=$kategoricek1['kategori_id'];
                      $urunsor1=$db->prepare("SELECT * FROM urun where kategori_id=:kategori and urun_durum=:durum order by urun_id DESC");
                      $urunsor1->execute(array('kategori' => $kategori_id , 'durum'=>1));
                      ?>
                      ...
                      while($uruncek1=$urunsor1->fetch(PDO::FETCH_ASSOC)) 
                      {
                       $urun_id=$uruncek1['urun_id'];
                       ?>
                       <option  <?php if ($kombin_iddort==$urun_id) { echo "selected='select'"; } ?> value="<?php echo $uruncek1['urun_id']; ?>">Kod: <?php echo $uruncek1['urun_id']; ?> | <?php echo $uruncek1['urun_ad']; ?> </option>
                       <?php 
                     } 
                     ?>
                   </optgroup>
           ...
           <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" id="first-name" name="kombin_ad" value="<?php echo $kombincek['kombin_ad'] ?>" required="required" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
             <select class="select2_multiple form-control" required="" name="kombin_cinsiyet" >
              <option <?php if($kombincek['kombin_cinsiyet']=="E") { echo "selected"; } ?> value="E">Erkek</option>
              <option  <?php if($kombincek['kombin_cinsiyet']=="K") { echo "selected"; } ?> value="K">Kadın</option>
            </select>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <textarea placeholder="Kombin Detay"  class="ckeditor" id="editor1" name="kombin_detay"><?php echo $kombincek['kombin_detay']; ?></textarea>
          </div>
        </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
         <select id="heard" class="form-control" name="kombin_durum" required>
          <option value="1" <?php if ($kombincek['kombin_durum']==1) { echo 'selected=""'; } ?>>Aktif</option>
          <option value="0" <?php if ($kombincek['kombin_durum']==0) { echo 'selected=""'; } ?>>Pasif</option>
        </select>
      </div>
    </div>

    <div class="form-group">
      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">kombin Onecikar<span class="required">*</span>
      </label>
      <div class="col-md-6 col-sm-6 col-xs-12">
       <select id="heard" class="form-control" name="kombin_onecikar" required>
        <option value="1" <?php if ($kombincek['kombin_onecikar']==1) { echo 'selected=""'; } ?>>Aktif</option>
        <option value="0" <?php if ($kombincek['kombin_onecikar']==0) { echo 'selected=""'; } ?>>Pasif</option>
      </select>
    </div>
  </div>
  ...
  <div class="form-group">
    <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
      <button type="submit" name="kombinduzenle" class="btn btn-success">Güncelle</button>
    </div>
  </div>
