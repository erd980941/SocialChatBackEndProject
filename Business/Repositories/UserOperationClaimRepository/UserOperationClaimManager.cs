    ...
    public class UserOperationClaimManager : IUserOperationClaimService
    {
        ...
        public IResult Add(UserOperationClaim userOperationClaim)
        {
            IResult result = BusinessRules.Run(
                ...
                IsOperationExist(userOperationClaim.OperationClaimId),
        ...
        private IResult IsUserExist(int userId)
        {
            ...
            if (result == null) { return new ErrorResult(UserOperationClaimMessages.UserNotExist); }
            return new SuccessResult();
        }
        private IResult IsOperationExist(int operationClaimId)
        {
            var result = _operationClaimService.GetById(operationClaimId).Data;
            if (result == null) { return new ErrorResult(UserOperationClaimMessages.OperationClaimNotExist); }
            return new SuccessResult();
        }
        ...
        private IResult IsOperationSetExistForAdd(UserOperationClaim userOperationClaim)
        {
            ...
            if (result != null) { return new ErrorResult(UserOperationClaimMessages.OperationClaimSetExist); }
            return new SuccessResult();
        }
